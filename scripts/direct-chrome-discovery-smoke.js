...
const { discoverPageWithDirectChrome, resolveChrome } = require('../server/services/directChromeRenderedDiscovery');
...
(async () => {
  ...
  assert.equal(page.discoveryTransport, 'DIRECT_CHROME_CDP');
